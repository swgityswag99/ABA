...
class User:
#takes in address database and prompts for delete record, add record, edit record
...
class Test:   
    def main():
        guy = record("jake", "garcia", "11900 Coronado Ave") 
        jake = record("james", "charles", "fox st") 
        dict = {
            "1" : guy,
            "2" : jake
        }

        User.edit_database(dict)
        print(dict["1"].address)
